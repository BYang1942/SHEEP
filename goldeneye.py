...
这个工具是一个dos工具，旨在给HTTP服务器带来沉重的负载
为了通过耗尽资源池让他们跪下。
...
class GoldenEye(object):
    ...
    def printHeader(self):
        ...
        # Taunt!
        print "GoldenEye Longshao firing!"
...
class Laser(Process):
    ...
    def generateRandomHeaders(self):
        ...
        # Randomly-added headers   # 随机添加的标头
        # These headers are optional and are  # 这些标头是可选的并且是
        # randomly sent thus making the # 随机发送的
        # header count random and unfingerprintable  # 标头计数随机且无法指纹
